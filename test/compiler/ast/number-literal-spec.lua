...
return function(self)
	self:is_truthy(number_literal.valid_number("1"))
	self:is_truthy(number_literal.valid_number("123"))
	self:is_truthy(number_literal.valid_number("123.456"))
	self:is_falsy(number_literal.valid_number(""))
	self:is_falsy(number_literal.valid_number("abc"))
	self:is_falsy(number_literal.valid_number("123."))
	self:is_falsy(number_literal.valid_number(".123"))
